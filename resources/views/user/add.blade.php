        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('user_post_add') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('twilio_phonenumber') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="twilio_phonenumber" type="text" class="form-control" value="{{ old('twilio_phonenumber') }}" name="twilio_phonenumber" required>
